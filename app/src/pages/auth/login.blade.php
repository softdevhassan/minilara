        ...
        <div class="w-full max-w-[340px] sm:max-w-[420px]">
            <div class="luxury-card p-4 xs:p-8 sm:p-10 ring-1 ring-white/5">
                ...
                <div class="text-center mb-5">
                    <span
                        class="text-xl font-semibold text-accent uppercase"
                        >{{ e(get_setting('APP_NAME', 'MINI LARA')) }}</span
                    >
                </div>
                <!-- Login Form -->
                <form action="" method="POST" class="space-y-4">
                    <div>
                        <label for="username" class="block text-[10px] font-semibold text-ts uppercase mb-2 px-1"
                            >Username</label
                        >
                        <div class="relative">
                    ...
                    <div>
                        <label for="password" class="block text-[10px] font-semibold text-ts uppercase mb-2 px-1"
                            >Password</label
                        >
                        <div class="relative">
            ...
            <div class="mt-8 text-center text-ts text-[9px] font-semibold uppercase">
                &copy; {{ date('Y') }} {{ e(get_setting('APP_NAME', 'Mini Lara')) }} | Developed by UpsolTech
            </div>
        </div>
    </div>
@endsection
